<script>
    ...
    $(document).ready(function() {
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/groups/get_groups') ?>',
            ...
            'fnServerData': function (sSource, aoData, fnCallback) {
                ...
                aoData.push({
                	...
                	$.ajax({'dataType': 'json', 'type': 'POST', 'url': sSource, 'data': aoData, 'success': fnCallback});
				 	...
				 	"aoColumns": [ null  , {"mRender":hrld} , <?php if($UserType == 'admin' || $UserType == 'admin_user' ) { echo '{"bSortable":false, "bSearchable": false},' ; } ; ?> {"bSortable":false, "bSearchable": false},]
