                ...
                <div class="tab-content">
                    <div id="edit_profile" class="tab-pane active">
                        <div class="col-lg-6">
                            ...
                            <?php if (($this->UserType == 'admin' || $this->UserType == 'company_admin' ) && $id != $this->session->userdata('user_id')) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_hidden('username', $user->username, 'class="form-control tip" id="username"  required="required"'); ?>
                                </div>
                                <div class="form-group">
                                    <?= lang('email', 'email'); ?>
                                    <?= form_input('email', $user->email, 'class="form-control tip" id="email"  required="required" readonly="readonly"'); ?>
                                </div>
