            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-lg-6">
                     ...
                     <?= form_open_multipart('admin/management/add_honorary_member'); ?> 

                        <div class="form-group">

                            <?= lang('Year', 'Year'); ?><samp class="required-star">*</samp>

                            <?= form_input('years', set_value('years'), 'class="form-control tip" placeholder="0000 - 0000" id="years"  '); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input('president_name', set_value('president_name'), 'class="form-control tip" id="president_name"  '); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input('secretary_name', set_value('secretary_name'), 'class="form-control tip" id="secretary_name"  '); ?>
