...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/management/get_executive_commitee/') ?>',
            ...
            "aoColumns": [  {"mRender":image} , null , null ,null, null,null,{"bSortable":false, "bSearchable": false},] 
        }); 
...
<section class="content"> 
    <a class='top-add-butto' href='<?php echo base_url('admin/management/add_executive_committee'); ?>' title='Add'><i class="fa fa-plus-circle" aria-hidden="true"></i></a>   
