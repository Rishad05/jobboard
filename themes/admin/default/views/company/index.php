...
<script>
    ...
    $(document).ready(function() {
        ...
        function image(n) {  
          if(n) {
            return '<img src="<?= base_url('uploads/company/'); ?>'+n+'" width="80">';
          }else{
            return '';
          }  
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('admin/company/get_companies/')?>',
            ...
            "aoColumns": [ {"mRender":image}, null, null, null, null, null, {"mRender":status}, {"mRender":hrld} , {"bSortable":false, "bSearchable": false},]
