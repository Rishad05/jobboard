  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="col-lg-12"> <?=form_open_multipart("admin/company/edit/{$info->id}", 'class="validation"');?>
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?= form_input('order_by', set_value('order_by',$info->order_by), 'class="form-control" id="order_by"'); ?> 
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <?php if ($info->logo) {?>
                      <img src="<?=base_url('uploads/company/' . $info->logo)?>" width="250"><br>
                    <?php }?>
