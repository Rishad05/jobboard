            ...
            <div class="row">
              <div class="col-md-6"> 
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="experience">Experience Requirement <samp class="required-star">*</samp></label> 
                  ...
                  <div class="form-group">
                    <label for="education_experience">Edutcation Requirement </label>
                    <?php
                  ...
                  <label for="minimum_requirement">Minimum Requirement</label><br>
                    ...
                    foreach ($minimum as $key => $value) {
                      echo '<label for="minimum_requirement">'.$value->title.'</label>'.
