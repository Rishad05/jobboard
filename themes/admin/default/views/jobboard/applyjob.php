...
<script>
    ...
    $(document).ready(function() {
        ...
        function attachment(n) {
            ...
            if(n !== null) { 
                return '<samp class="label label-success" ><a title="View CV" style="color:#ffffff" target="_blank" href="<?php echo base_url("uploads/cv/"); ?>'+n+'">View</a></samp>'; 
            }
        ...
        $('#catData').dataTable({
            ...
            "aoColumns": [  null, null, null,null, null, null, {"mRender":attachment},   {"mRender":hrld} , {"bSortable":false, "bSearchable": false},]				
