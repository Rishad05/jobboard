...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?=site_url('admin/jobboard/get_minimum_requirement/')?>',
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <div class="col-xs-5">
                            <?php if ($info) {?>
                                <?=form_open_multipart("admin/jobboard/minimum_requirement/{$info->id}");?>
                                ...
                                <?php echo form_close(); ?>
                            <?php } else {?>
                                <?=form_open_multipart("admin/jobboard/minimum_requirement");?>
                                <div class="form-group">
                                    <label for="title">Title<samp class="required-star">*</samp></label>
