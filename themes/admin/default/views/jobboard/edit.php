    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-lg-12">
                        <?= form_open_multipart("admin/jobboard/edit/{$info->id}", 'class="validation"'); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="companey_id">Company Name<samp class="required-star">*</samp></label>
                                    <!-- <?= form_input('industry', $info->industry, 'class="form-control tip" id="industry" required="required"'); ?> -->
                                    <?php
                  ...
                  ?>
                                ...
                                <div class="form-group">
                                    <label for="education_experience">Education Requirement <samp
                                            class="required-star">*</samp> </label>
                  ...
                  foreach ($minimum as $key => $value) {
                    ...
                    echo form_checkbox('minimum_requirement[]', $value->id, $select, 'class="checkbox"') . '<label>' . $value->title . '</label>';
                  }
                  ?>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" name="home_page" value="1" id="home_page" <?php if ($info->home_page) {
                                                                                      echo "checked";
                                                                                    } else {
                                                                                      echo '';
                                                                                    } ?> />
