  ...
  <div class="row">   
    <div class="col-xs-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="col-lg-12"> <?php echo form_open_multipart("admin/services/edit/{$info->id}", 'class="validation"'); ?> 
            <div class="row">
              <div class="col-md-6">  
                  <div class="form-group">
                    <label for="title">Title<samp class="required-star">*</samp></label>
                    <?= form_input('title', set_value('title',$info->title), 'class="form-control tip" id="title" required="required"'); ?>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="descriptions">Short Descriptions </label>
                    <?php
                    $descriptions = '';
                    if(isset($_POST['short_descriptions'])){
                      $descriptions = $_POST['short_descriptions'];
                    }
                    ?>
                    <?= form_textarea('short_descriptions', $info->short_descriptions, 'class="form-control tip" id="short_descriptions"'); ?>
                  </div> 
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?= form_input('icon',  $info->icon , 'class="form-control tip" id="icon" required="required" placeholder="<i class=\'fas fa-icon\'></i> "'); ?> 
                  </div> 
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <?php if($info->thumbnail){ ?>
                      <img src="<?= base_url('uploads/services/'.$info->thumbnail); ?>" width="120"><br>
                    <?php } ?>
