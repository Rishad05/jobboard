    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">  
                    <?= form_open_multipart('admin/pages/add','class="validation fv-form fv-form-bootstrap"'); ?>
                    <div class="col-lg-10">                        	  
                        <div class="form-group">
                            <?= lang('Page Title', 'title'); ?><span class="required-star">*</span>
                            <?= form_input('title', set_value('title'), 'class="form-control tip" id="title" placeholder="Page Name" required="required"'); ?>
                        </div>   
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_textarea('content', set_value('content'), 'class="form-control tip" id="content" '); ?>
                        </div>
                        <div class="form-group">
