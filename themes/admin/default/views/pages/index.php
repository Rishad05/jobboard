<script>
    $(document).ready(function() {  
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/pages/get_pages') ?>',
            ...
            "aoColumns": [ null, {"mRender":status}, {"bSortable":false, "bSearchable": false},]          
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <a class="goBack add_goback" href="<?= base_url('admin/pages/add'); ?>">Add New</a> 
