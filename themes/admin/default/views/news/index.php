...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/news/get_news/'.$v) ?>',
            ...
            "aoColumns": [  null , null, {"mRender":home}, null,  {"mRender":hrld}, {"mRender":status}, {"bSortable":false, "bSearchable": false},]
...
<section class="content"> 
    <a class='top-add-butto' href='<?php echo base_url('admin/news/add'); ?>' title='Add'><i class="fa fa-plus-circle" aria-hidden="true"></i></a>   
