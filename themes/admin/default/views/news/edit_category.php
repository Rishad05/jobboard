...
data-easein="flipYIn" class="modal posModal in" style="display: block; padding-left: 17px;">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php //print_r($info); //print_r($this->session->userdata()); //print_r($info);  ?>
              ...
              <div class="col-xs-12">
                      ...
                      <div class="box-body">
                          ...
                          <div class="col-lg-12">
                           ...
                           <?= form_open('admin/news/edit_category/'.$info->id); ?>  
 
                              <div class="form-group">
                                <label for="Group name">Category Title<samp class="required-star">*</samp></label>
                                <?= form_input('title', $info->title, 'class="form-control tip" id="title" required="requires"'); ?>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <?= form_submit('update_now', lang('Update Now'), 'class="btn btn-primary"'); ?>
