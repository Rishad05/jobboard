...
<script>
    ...
    $(document).ready(function() {
        ...
        function image(n) {
            if(n){
                return '<a target="_blank" href="<?php echo base_url('uploads/slider/'); ?>'+n+'"><img width="100px" src="<?php echo base_url('uploads/slider'); ?>/'+n+'"></a>';
            }
        }
        ...
        $('#catData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('admin/slider/get_slider/') ?>',
            ...
            "aoColumns": [  {"mRender":image}, null, null, null, null ,{"mRender":hrld} , {"bSortable":false, "bSearchable": false},] 
        }); 
...
<section class="content"> 
    <a class='top-add-butto' href='<?php echo base_url('admin/slider/add'); ?>' title='Add'><i class="fa fa-plus-circle" aria-hidden="true"></i></a>   
