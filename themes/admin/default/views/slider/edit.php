  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        ...
        <?php //print_r($info); ?>
        <div class="box-body">
          <div class="col-lg-12"> <?php echo form_open_multipart("admin/slider/edit/{$info->id}", 'class="validation"'); ?>
            ...
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?=form_input('link', set_value('link',$info->link), 'class="form-control tip" id="link" ');?>
                  </div>
                  <div class="form-group">
                    <label for="description">Description</label>
                    <?=form_textarea('description', $info->description, 'class="form-control tip" id="description"');?>
                  </div>
                  <?php if ($info->image) {?>
                    <div>
                      <img width="400px" src="<?php echo base_url('uploads/slider/' . $info->image); ?>">
                    </div>
                  <?php }?>
                  <div class="form-group">
              ...
              <div class="form-group">
              <?=form_submit('slider_update', 'Update Now', 'class="btn btn-primary"');?>
            </div>
            </div>
