					...
					<div class="section_content">  
						...
						<div class="form-row mb-3">
							...
							<div class="col"> 
								...
								<?= form_input('identity',set_value('identity'),'class="form-control" placeholder="Email"'); ?>
						...
						<div class="form-row">
							...
							<div class="col-md-12"> 
								...
								<div class="forget_pass_login">
									<p><a  data-toggle="modal" data-target="#myModal" href="#">Forgot your password?</a></p><!-- Don't worry! click <a  data-toggle="modal" data-target="#myModal" href="#">here</a> To Reset | -->
									<!-- <a href="<?php echo base_url('registration'); ?>">Become a Member</a> -->
								</div>
								<div class="btn_links">
                                    <a href="<?php echo base_url('registration'); ?>" class="btn btn-primary btn_small"><i class="fas fa-user"></i> Apply For Your Membership</a>
                                    <a href="<?php echo base_url('registration'); ?>" class="btn btn-primary btn_small"><i class="fas fa-calendar-alt"></i> Renew Your Membership</a>
                                </div>
