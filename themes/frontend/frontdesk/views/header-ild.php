...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
		...
		<title>FDB - Frontdesk Bangladesh</title>
	</head>
					...
					<div class="row clearfix">
						...
						<div class="col-md-12">
							<ul class="list-inline float-md-left">
								<li>
									<i class="fa fa-phone-volume"></i> <a href="tel:<?= $phones[0] ?>"><?= $phones[0] ?></a> , <a href="tel:<?= $phones[1] ?>"><?= $phones[1] ?></a>
								</li>
								<li>
					  ...
					  <div class="collapse navbar-collapse" id="navbarNav">
					    <ul class="navbar-nav ml-auto">
					      ...
					      <li class="nav-item has_sub_menu">
								<a class="nav-link" href="<?= base_url('about');?>">About Us <i class="fas fa-angle-down"></i></span></a>
								<ul class="list-inline sub_menu">
									<li><a href="<?= base_url('teams');?>">Our Team</a></li>
									<li><a href="<?= base_url('sister_concern');?>">Our Sister Concern</a></li>
									<li><a href="<?= base_url('aos');?>">AOS</a></li>
									<li><a href="<?= base_url('aos2');?>">AOS2</a></li>
									<li><a href="<?= base_url('partners');?>">Our partners</a></li>	
								</ul>
						   </li>
					      <li class="nav-item has_sub_menu">
					      	<?php $services = $this->site->whereRows('services','status',1,'ASC'); ?>
					        <a class="nav-link" href="<?= base_url('services');?>">Services <i class="fas fa-angle-down"></i></a>
					        <ul class="list-inline sub_menu">
					        	<?php if($services){ 
					        		foreach ($services  as $key => $service) { ?>
					        		 	<li><a href="<?= base_url('services/details/'.strtolower( str_replace(' ','_',$service->title) ));?>"><?= $service->title; ?></a></li>
					        	<?php } } ?> 
					        </ul>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?= base_url('training');?>">Training</span></a>
					      </li>
					      <li class="nav-item">
					        <a class="nav-link" href="<?= base_url('jobs');?>">Current Job</span></a>
					      </li>
					      <li class="nav-item has_sub_menu">
								<a class="nav-link" href="<?= base_url('news');?>">News & Media <i class="fas fa-angle-down"></i></span></a>
								<ul class="list-inline sub_menu">									
