                     ...
                     <div class="titlebar-sc-wrap">
                        ...
                        <div class="sc-boxed-call-to-cation  ">
                           <div class="tg-titleandbtns">
                              <h1 style="color:#ffffff"><?= $services->title; ?><br>
                              </h1>
         ...
         <div class="row">
             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                 <ol class="tg-breadcrumb">
                     ...
                     <li class="0-item">
                         <a href="<?=base_url('service')?>">Service</a></li>
                         <li class="arrow-item"><i class="fas fa-angle-right"></i></li>
                     <li class="last-item"><?= $services->title; ?></li>
                 </ol>
             </div>
         </div>
      </div>
...
<section class="content_section About_us_section mt-5 mb-5">
   <div class="container">
      <div class="row">
         <?php $this->load->view($this->frontend_theme . '/services/sidebar'); ?>
