                     ...
                     <div class="contact-detail-main">
                        ...
                        <ul class="tg-contactinfo">
                           <li>
                              ...
                              <address>Lane # 5 (Eastern Road),
                                 House# 363,Baridhara DOHS,
                           ...
                           <li>
                              ...
                              <div class="tg-detailbox"> 
                                 <span class="tg-phone">0800 - 1234 - 562 - 6</span>
                                 <span class="tg-fax">+4 1234 5678 - 9</span>             
                              </div>
                           </li>
                           <li>
                              ...
                              <div class="tg-detailbox"> 
                                 <span class="tg-email">
                                 <a href="mailto:info@frontdeskbd.com">info@frontdeskbd.com</a>
                                 </span>
                                 <span class="tg-support">
                                 <a href="mailto:support@domain.com">support@frontdeskbd.com</a>
                                 </span>        
                              </div>
                           </li>
                        </ul>
                  ...
                  <div class="sc-contact-form tg-contactus  ">
                     <div id="tg-content" class="tg-content">
                        <div class="tg-sectionhead">
                           ...
                           <div class="tg-description text-left">
                              <p> Frontdesk Bangladesh (FDB) is a full service management consultancy offering focused expertise in human resource management.
                      ...
                      <input type="file" name="myfile" /> <label>Attach CV (only doc file)</label>
                    </div>
                                       </div>
                                    </div>
                                    <div class="form-row">
