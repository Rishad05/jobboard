        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row clearfix contact_page_contact">
                        <div class="col-md-12">
                            <div class="contact_info_box">
                               
                                <h4>ROMO Fashion Today Ltd.</h4>
                                
                                <p><span><i class="fas fa-map-marker-alt"></i></span><?= $this->Settings->address; ?></p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="contact_info_box">
                                ...
                                <!-- <h4>Email</h4> -->
                                 <p><span><i class="fas fa-envelope"></i></span><a href="mailto:<?= $this->Settings->default_email; ?>"><?= $this->Settings->default_email; ?></a></p> 
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="contact_info_box">
                                ...
                                <!-- <h4>Phone</h4> -->
                                 <p><span><i class="fas fa-phone"></i></span><a href="tel:<?= $this->Settings->tel; ?>"><?= $this->Settings->tel; ?></a></p> 
                            </div>
                        </div>
                    </div>

                    <div class="Content_right">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1824.2775091523583!2d90.40172088134246!3d23.869930031747376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c43aaca0b7bf%3A0xaf023fc07721eaaa!2s62+Road-15%2C+Dhaka+1230!5e0!3m2!1sen!2sbd!4v1566190474522!5m2!1sen!2sbd" width="100%" height="200" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
