					    ...
					    <ul class="navbar-nav ml-auto">
					      ...
					      <li class="nav-item has_sub_menu" id="about">
								...
								<ul class="list-inline sub_menu">
									...
									<!-- <li id="sister_concern"><a href="<?= base_url('sister_concern');?>">Our Sister Concern</a></li> -->
					        ...
					        <ul class="list-inline sub_menu">
					        	<?php if($services){ 
					        		foreach ($services  as $key => $service) { ?>
					        		 	<li><a id="<?= strtolower( str_replace(' ','_',$service->title)) ?>" href="<?= base_url('services/details/'.strtolower( str_replace(' ','_',$service->title) ));?>"><?= $service->title; ?></a></li>
					        	<?php } } ?> 
					        </ul>
					      </li>
