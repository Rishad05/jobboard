        ...
        <table width="100%" border="0" border-collapse="collapse" style="border-spacing:0;width:80%;margin:0 auto;">
            <tbody border="0">
                ...
                <tr>
                    <td colspan="3" style="background:#059348;text-align:center; padding:20px;">
                        <a style="" href="<?php echo $signin_url; ?>" title="FareTrim" rel="home" target="_blank"> <img width="270" height="auto" src="http://timesavedhaka.com/bos/themes/frontend/bos_theme/assets/images/mail_logo.png"  alt="BOS"> </a>
                    </td>
                ...
                <tr style="background:#f5f5f5">
                    <td colspan="3" style="padding:50px 35px;">
                        <h3 style="text-transform: capitalize;color:#059348">Hi <?php echo $name; ?></h3> 
                        <p style="font-size: 18px;color: #333;"> Welcome To  Bangladesh Orthopaedic Society, before we get started, please confirm your email addess below</p> 


                          <a  href="<?php echo $varify_url; ?>" style="width: 150px;display: block;background: #059348;color: #fff;text-decoration: none;padding: 15px 25px;text-align: center;">Confirm Email</a>
          ...
          <tr style="background:#059348;color:#fff;text-align: center;line-height: 25px;font-size: 18px ">
            <td colspan="3 " style="padding:35px 35px;border-spacing: 0; ">
                Our Location : Sher-e-Bangla Nagar, Dhaka - 1207, Bangladesh</br></br>
