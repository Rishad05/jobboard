                            ...
                            <div class="titlebar-sc-wrap">
                                ...
                                <div class="sc-boxed-call-to-cation  ">
                                    <div class="tg-titleandbtns">
                                        <h1 style="color:#ffffff">My Applied Jobs<br>
                                        </h1>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ol class="tg-breadcrumb">
                        ...
                        <li class="arrow-item"><i class="fas fa-angle-right"></i></li>
                        <li class="last-item">My applied job</li>
                    </ol>
                </div>
            </div>
        </div>
...
<section class="Current_Jobs_full_section">
    <div class="container">
        <!-- <div class="row mb-2">
            <div class="col-md-12">
                <?= form_open_multipart("", 'class="validation"  method="GET"'); ?>
                <div class="form-row mb-3">
                    <div class="col">
                        <?= form_input('keywords', set_value('keywords', $keywords), 'class="form-control" id="keywords" placeholder="Keywords" '); ?>
                    </div>
                    <div class="col">
                        <?= form_input('location', set_value('location', $location), 'class="form-control" id="location" placeholder="Location" '); ?>
                    </div>
                </div>
                <div class="form-row mb-3">
                    <div class="col-md-12">
                        <div class="select-style">
                            ...
                            ?>
                            <?= form_dropdown('category', $cat, set_value('category', $getCat), 'class="form-control tip select2 w-100" id="category"'); ?>
                        </div>
                    </div>
                </div>
                <div class="form-row">
                            ...
                            if ($jobtypes) {
                                ...
                                foreach ($jobtypes as $key => $jobtype) {
                                    ...
                                    if (isset($_GET['job_type'])) {
                                        ...
                                        if (isset($job_type[$key])) {
                                            if ($job_type[$key] == $jobtype->id) {
                                                $chack = TRUE;
                                            }
                                        }
                                    } ?>
                                    <li>
                                        <label for="job_type_freelance" class="freelance">
                                            <input type="checkbox" <?php if ($chack) {
                                                                        echo 'checked="checked"';
                                                                    } ?> value="<?= $jobtype->id ?>" name="job_type[]"> <?= $jobtype->name ?></label>
                                    </li>
                            <?php
                                    $chack = '';
                                }
                    ...
                    <div class="inp_sub_srch">
                        <input type="submit" name="search" value="Search">
                    </div>
                    <div class="inp_res_found">
                        ...
                        foreach ($applied_jobs as $key => $value) {
                            foreach ($value as $key => $job) { ?>
                                ...
                                <li class="job_listing type-job_listing" style="visibility: visible;">
                                    <a href="<?= base_url('jobs/applicant_job_details/' . $job->id); ?>">
                                        ...
                                        <ul class="meta">
                                            ...
                                            <li class="date"> <span class=""> <i class="far fa-clock"></i></i></span>
                                                <time datetime="2019-09-04">Posted <?= $this->tec->timeago($job->created_at);  ?> </time> <br> <span class="calen"><i class="far fa-calendar-alt"></i></span> <?= date('D M d, Y', strtotime($job->last_date)); ?>
                                            </li>
                                        </ul>
                                    </a>
                                </li>
