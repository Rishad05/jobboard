            ...
            <div class=" col-sm-12">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <input type="hidden" class="form-control tip" id="email" required="required" name="email" value="<?= $this->session->userdata('email'); ?>">
                    </div>
                </div>
                <!-- <div id="form-div">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class=" custom-file form-group col-md-6">
                            <div class="form-group">
                                <label>Attach CV (doc|docx|pdf file)</label>
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <span class="btn btn-default btn-file">
                                            Choose file <input type="file" name="userfile" id="imgInp">
                                        </span>
                                    </span>
                ...
                <?php } else { ?>
                    <div class="d-flex justify-content-center p-3  m-3">
                        <div class="have_account_area">
                            ...
                            <p> Do you want to apply for this possition? <a href="<?= base_url('auth/applicant_login') ?>">Login</span></a></p>

                            <p> Do you have't account? <a href="<?= base_url('auth/applicant_register') ?>">Create Account </a></p>
                        </div>
                    </div>
                <?php } ?>
                <?= form_close(); ?>
