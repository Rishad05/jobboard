                  ...
                  font-weight: 500;">Education </h2>
                                ...
                                <?php foreach ($acadamic_info as $key => $value) { ?>
                                    <div class="category_item" style=" margin-top: 40px;    padding-bottom: 10px;">
                                        ...
                                        <ul style="   margin-top: 15px;">
                                            <li style="font-size: 16px;font-weight: 400; margin-top: 5px;">Institute:
                                                <b><?= $value->name_of_institution ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px;font-weight: 400;margin-top: 5px;">Pass Year: <b>
                                                    <?= $value->passing_year ?? '' ?> </b> </li>
                                            <li style="font-size: 16px; font-weight: 400;margin-top: 5px;">
                                                Concentration/Major: <b> <?= $value->major ?? '' ?></b> </li>
                                            <li style="font-size: 16px; font-weight: 400;margin-top: 5px;">Result:
                                                <b><?= $value->result ?? '' ?> (Out of <?= $value->result_out_of ?? '' ?>)
                                                </b>
                                            </li>
                            ...
                            <div class="right_item" style=" margin-bottom: 20px;">
                                ...
                                <div class="category_item" style=" margin-top: 40px; padding-bottom: 10px;border-bottom: 1px solid #b0afaf;">
                                    <?php foreach ($employment_history as $key => $value) { ?>
                                        <h4 style="  font-size: 18px; font-weight: 500;"><?= $value->designation ?? '' ?>
                                        </h4>
                                        <ul style="   margin-top: 15px; padding-left: 20px;">
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Industry Type: <b><?= $value->industry_type ?? '' ?></b>
                                            </li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Department: <b><?= $value->department ?? '' ?></b>
                                            </li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Key Reponsibility: <b><?= $value->key_responsibility ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Company: <b> <?= $value->organization_name ?? '' ?></b> </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Address: <b> <?= $value->address ?? '' ?></b> </li>
                                        </ul>
                                    <?php  } ?>
                                </div>
                            </div>
                            <div class="right_item" style=" margin-bottom: 20px;">
                                ...
                                <div class="category_item" style=" margin-top: 40px;    padding-bottom: 10px; ">
                                    <?php foreach ($training_info as $key => $value) { ?>
                                        ...
                                        <ul style="margin-top: 15px; padding-left: 20px;">
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Institution Name: <b><?= $value->institution_name ?? '' ?></b>
                                            </li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Address: <b><?= $value->address ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Duration: <b><?= $value->duration ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Training Period: <b><?= $value->start_date ?? '' ?> -
                                                    <?= $value->end_date ?? '' ?> </b> </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Skills: <b> <?= $value->skills ?? '' ?></b> </li>
                            ...
                            <div class="right_item" style=" margin-bottom: 20px;">
                                <div class="resume_title_grid" style="     display: grid; grid-template-columns: minmax(0, 28px)repeat(1, minmax(0, 1fr));align-items: center; gap: 12px;">
                                    ...
                                    <h3 style=" font-size: 22px; font-weight: 500;">Professional <b>Qualification</b>
                                    </h3>

                                </div>
                                <div class="category_item" style=" margin-top: 40px;    padding-bottom: 10px;border-bottom: 1px solid #b0afaf;">
                                    <?php foreach ($professional_qualification as $key => $value) { ?>
                                        <h4 style="  font-size: 18px; font-weight: 500;"><?= $value->certificate ?? '' ?>
                                        </h4>
                                        <ul>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Awarding Body: <b><?= $value->awarding_body ?? '' ?></b>
                                            </li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                            ...
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Passing Year: <b><?= $value->passing_year ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Result: <b> <?= $value->result ?? '' ?></b> </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Remarks: <b> <?= $value->remarks ?? '' ?></b> </li>
                            ...
                            <div class="right_item" style=" margin-bottom: 20px;">
                                ...
                                <div class="category_item" style=" margin-top: 40px;    padding-bottom: 10px;border-bottom: 1px solid #b0afaf;">
                                    <?php foreach ($language_proficincy as $key => $value) { ?>
                                        ...
                                        <ul>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Speaking: <b><?= $value->speaking     ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Writing: <b><?= $value->writing ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Reading: <b><?= $value->reading ?? '' ?></b>
                                            </li>
                                            <li style="font-size: 16px; font-weight: 400; margin-top: 5px;list-style-type: disc;">
                                                Listening: <b><?= $value->listening ?? '' ?></b>
                                            </li>
                                        </ul>
                                    <?php  } ?>
                                </div>
