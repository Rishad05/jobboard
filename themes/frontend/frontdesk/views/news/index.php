                    ...
                    <div class="col-md-4 mb-4">
                        <div class="news_fdb_sec">
                          <?php if ($news->thumbnail) {?>
                              <?php if($news->slug){ ?>
                                <a href="<?=base_url('news/details/' . $news->slug);?>"><img src="<?=base_url('uploads/news/' . $news->thumbnail);?>" class="w-100" alt="Jobs"></a>
                                <?php } else { ?>
                                <a href="<?=base_url('news/details/' . $news->id);?>"><img src="<?=base_url('uploads/news/' . $news->thumbnail);?>" class="w-100" alt="Jobs"></a>
                                <?php } ?> 
                          <?php }?>
                            <div class="news_info">
                                <?php if($news->slug){ ?>
                                <a href="<?=base_url('news/details/' . $news->slug);?>"><h4 class="title-min-height"> <?=$news->title;?></h4></a>
                                <?php } else { ?>
                                <a href="<?=base_url('news/details/' . $news->id);?>"><h4> <?=$news->title;?></h4></a>
                                <?php } ?>
