		...
		<section class="footer_bigs_section">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="foot_big_inner_sect">
							...
							<p class="copyright_main">
								© 2019 frontdeskbd.com All Rights Reserved.
							</p>
							<p class="footer_big_about_dtl">
					...
					<div class="col-md-4">
						<div class="foot_big_inner_sect">
							...
							<div class="foonter_icon_div">
								<h5>Phone</h5>
								<div class="footer_contack_icon"><i class="fas fa-phone-volume"></i></div> <span><?=$this->Settings->phone_number?></span>
							</div>
							<div class="foonter_icon_div">
								<h5>Email</h5>
								<a href="#">
									<div class="footer_contack_icon">
						...
						<div class="foot_big_inner_sect">
							...
							<div class="big_foot_list">
								<ul>
									...
									<li><a href="<?=base_url('services');?>">What We Offer</a></li>
						...
						<div class="footer_last_inner">
							...
							<div class="footer_social_last_icon">
								<a href="<?=$this->Settings->facebook?>" class="fb_social">
                              	...
                              	<a target="_blank" href="<?=$this->Settings->twitter?>" class="tw_social">
                              	<i class="">
  ...
  theme_color="#d696bb">
      ...
      <!-- Your customer chat code -->
      <div class="fb-customerchat" attribution=setup_tool page_id="548970622281818"
  theme_color="#4a7bb9">
      </div>
