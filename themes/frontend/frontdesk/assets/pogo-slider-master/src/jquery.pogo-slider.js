...
(function ( $, window, document, undefined ) {
	...
	Plugin.prototype = {
		...
		_createDirButtons: function () {
			...
			$('<button class="pogoSlider-dir-btn pogoSlider-dir-btn--prev"><i class="pg_inner_icon fas fa-chevron-left"></i></button>').appendTo(self.$element).on('click', function () {
				self.prevSlide();
			});

			$('<button class="pogoSlider-dir-btn pogoSlider-dir-btn--next"><i class="pg_inner_icon fas fa-chevron-right"></i></button>').appendTo(self.$element).on('click', function () {
				self.nextSlide();
			});
